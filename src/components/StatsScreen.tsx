    ...
    <div className="modal-overlay" onClick={dismiss}>
      ...
      >
        ...
        <div className="stats-counter-info">
          ...
          <p>Счётчик показывает не сколько слов ты видел, а насколько хорошо их знаешь.</p>
          <p>Каждое слово добавляет долю по своему уровню: только начал — чуть-чуть, поднял выше — больше, довёл до архива — как целое выученное слово.</p>
          <p>Просто отвечай на карточки — цифра растёт сама.</p>
        </div>
      </div>
    </div>
  );
