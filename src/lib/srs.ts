...
// Шкала под реальную базу (~7800 карточек). CEFR-привязка по объёму словаря:
// A1 ≈ 800, A2 ≈ 1500, B1 ≈ 3200, B2 ≈ 5400, C1 ≈ 7000+. Потолок = весь словарь Lemma.
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    description: 'Около 5400 слов — уровень B2. Свободно смотришь сериалы с субтитрами, читаешь статьи и несложные книги в оригинале, обсуждаешь абстрактные темы. Полноценный рабочий английский.',
  },
  {
    min: 6600,
    title: 'Уверенный B2',
    description: 'Понимаешь живую речь почти без усилий, читаешь без словаря, выражаешь сложные мысли. На пороге продвинутого уровня — остаётся отшлифовать детали.',
  },
  {
    min: 7800,
    title: 'C1 — Свободный · весь словарь Lemma',
    description: 'Ты выучил весь словарный запас приложения — около 7800 слов. Это уверенный C1: понимаешь фильмы, книги и подкасты в оригинале, свободно общаешься на любые темы. Дальше — только живая практика.',
  },
];
